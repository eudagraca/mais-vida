...
public class PostAdapterDonnor extends RecyclerView.Adapter<PostAdapterDonnor.PostViewHolder> {
    ...
    public PostAdapterDonnor(Context context, List<Post> postsList) {
        mContext = context;
